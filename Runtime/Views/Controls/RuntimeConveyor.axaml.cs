...
{
    private static SolidColorBrush OffBrush = new(Color.FromRgb(128, 128, 128)); // Dark gray default
    private static SolidColorBrush OnBrush = new(Color.FromRgb(0, 128, 0)); // Green default
    ...
    public void ApplyDescriptor(ComponentDescriptor d)
    {
        ...
        if (!string.IsNullOrEmpty(borderColorStr))
            TheBorder.BorderBrush = new SolidColorBrush(ParseColor(borderColorStr));
